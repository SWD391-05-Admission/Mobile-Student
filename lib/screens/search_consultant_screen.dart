...
class SearchConsultantScreen extends StatefulWidget {
  const SearchConsultantScreen();
  static const routeName = '/search-consultant-screen';
  @override
  _SearchConsultantScreenState createState() => _SearchConsultantScreenState();
}

class _SearchConsultantScreenState extends State<SearchConsultantScreen> {
  @override
